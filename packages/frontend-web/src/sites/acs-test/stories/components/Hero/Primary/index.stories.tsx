...
export const LightTextWithDarkOverlayLeft: Story = {
  args: {
    ...data.lightText,
    styles: ['acs-test-hero', 'acs-test-hero--primary', 'acs-test-hero--text-light', 'acs-test-hero--overlay-dark'],
  },
};
...
export const LightTextWithoutOverlayLeft: Story = {
  args: {
    ...data.lightText,
    styles: ['acs-test-hero', 'acs-test-hero--primary', 'acs-test-hero--text-light'],
  },
};
...
export const DarkTextWithLightOverlayLeft: Story = {
  args: {
    ...data.darkText,
    styles: ['acs-test-hero', 'acs-test-hero--primary', 'acs-test-hero--text-dark', 'acs-test-hero--overlay-light'],
  },
};
...
export const DarkTextWithoutOverlayLeft: Story = {
  args: {
    ...data.darkText,
    styles: ['acs-test-hero', 'acs-test-hero--primary', 'acs-test-hero--text-dark'],
  },
};
