    ...
    return (
      <>
        ...
        <div style={{ display: 'flex', gap: 'var(--size-spacing-medium)', flexWrap: 'wrap', backgroundColor: reversedBackgroundColor, padding: reversedPadding }}>
          <a href="/index#hello-world" className={`acs-test-btn ${args.variant} acs-test-btn--caret`}>
            {args.label}
          </a>
          <a href="/index2#hello-world" className={`acs-test-btn ${args.variant} acs-test-btn--download`}>
            Download document
          </a>
          <a href="/index3#hello-world" className={`acs-test-btn ${args.variant} acs-test-btn--video`}>
            Watch video
          </a>
          <a href="/index4#hello-world" className={`acs-test-btn ${args.variant} acs-test-btn--external`}>
            External link
          </a>
          <a href="/index5#hello-world" aria-disabled="true" className={`acs-test-btn ${args.variant}`}>
            Disabled
          </a>
        </div>
        ...
        <div style={{ display: 'flex', gap: 'var(--size-spacing-medium)', flexWrap: 'wrap', backgroundColor: reversedBackgroundColor, padding: reversedPadding }}>
          <button type="button" className={`acs-test-btn ${args.variant} acs-test-btn--caret`}>
            {args.label}
          </button>
          <button type="button" className={`acs-test-btn ${args.variant} acs-test-btn--download`}>
            Download document
          </button>
          <button type="button" className={`acs-test-btn ${args.variant} acs-test-btn--video`}>
            Watch video
          </button>
          <button type="button" className={`acs-test-btn ${args.variant} acs-test-btn--external`}>
            External link
          </button>
          <button type="button" disabled aria-disabled="true" className={`acs-test-btn ${args.variant}`}>
            Disabled
          </button>
        </div>
      </>
...
export const Button: Story = {
  args: {
    label: 'string',
    variant: 'acs-test-btn--primary',
    icon: 'acs-test-btn--caret'
  },
  render: args => {
    return (
      <a href="/index2#hello-world" className={`acs-test-btn ${args.variant} ${args.icon}`}>
         {args.label}
      </a>
    )
  },
...
export const Secondary: Story = {
  args: {
    label: 'Internal link',
    variant: 'acs-test-btn--secondary',
  },
} satisfies Story;
...
export const TextPrimary: Story = {
  args: {
    label: 'Internal link',
    variant: 'acs-test-btn--text-primary',
  },
} satisfies Story;
...
export const TextSecondary: Story = {
  args: {
    label: 'Internal link',
    variant: 'acs-test-btn--text-secondary',
  },
} satisfies Story;
...
export const TextReversed: Story = {
  args: {
    label: 'Internal link',
    variant: 'acs-test-btn--text-reversed',
  },
} satisfies Story;
